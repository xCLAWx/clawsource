...
if MsgText[2] == "ايدي كلاو" 	then return unlock_ID(msg) end
...
if MsgText[2] == "ايدي كلاو" 	then return lock_ID(msg) end
...
•مـن التفنيش والتوجيه‌‏ والتكرار وغيره...
...
local inline = {{{text="•قناه‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/xclawx"}}}
send_key(msg.sender_user_id_,'  [•قناة سورس : انـجـل](https://t.me/XCLAWX)',nil,inline,msg.id_)
return false
end
...
‹Ｃⴼ › ᎦỗᵿⲅᎦẽ ⟿ [Ｃ ⴼ ᗩ ＮＥＬ](t.me/xCLAWx)

☏ ＤＥＶ➱ [Ᏼ ᗩＳＥＬ ●](t.me/XB_0B)

☏ ＤＥＶ➱ [ＳỖＮᶦ Ϲ ●](t.me/Soonicxx)
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(max..':WELCOME_BOT'),[[•اهلا انآ بوت اسـمـي ]]..redis:get(max..':NameBot:')..[[ 
...
SendMention(msg.chat_id_,datau.id_,msg.id_,"•العضو » "..USERNAME.."\n•قمـت بتكرار اكثر مـن "..NUM_MSG_MAX.." رسـآله‌‏ , لذآ تم تقييدك مـن آلمـجمـوعه‌‏ .\n",12,USERCAR) 
return false
end)
end 
