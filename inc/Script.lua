...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/Sourcexclawx"}}}
send_key(msg.sender_user_id_,'  [-قناة سورس : كلاو ل](https://t.me/Sourcexclawx)',nil,inline,msg.id_)
return false
end
...
return [[
• ↵ مطور السورس : [basil](t.me/xb_0b)
• ↵ مطور السورس : [sonic](t.me/Soonicxx)
• ↵ قناة السورس :[Sourcexclawx](t.me/xclawx)
 ♠
]]
end
