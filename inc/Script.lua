...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
    if data.photos_[0] then 
        ...
        sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'★ 𝑼𝒔𝒆𝒓𝑵𝒂𝒎𝒆 ↣  '..UserNameID..' .\nس   '..msgs..' .\n★ 𝑺𝒕𝒂𝒔𝒕 ↣  '..msg.TheRank..' .\n★  𝒊𝒅 ↣ '..msg.sender_user_id_..' .\n★ 𝗖𝗵𝗮 𖥳  @xclawx .',dl_cb,nil)
        else
...
send_key(msg.sender_user_id_,'  [- قناة سورس : كلاو ](https://t.me/xclawx)',nil,inline,msg.id_)
return false
end
...
elseif Text== "شنو رئيك بهاذا" or Text== "رئيك بي" or Text== "رئيك بهاذه" then 
return sendMsg(msg.chat_id_,msg.id_,he[math.random(#he)])
elseif Text== "رئيك بيها" or Text=="رئيك بيه" or Text== "رئيك " then 
