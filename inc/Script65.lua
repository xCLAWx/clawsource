...
مطـور السورس  »  [باسـل](http://t.me/XB_0B)
 قناة السورس   »  [ســورس كلــاو](t.me/XCLAWX)
...
local su = {
  ...
  elseif Text== "مالك السورس" then return sendMsg(msg.chat_id_,msg.id_,"[باسـل-](t.me/XB_0B")
  elseif Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[باسـل-](t.me/XB_0B")
